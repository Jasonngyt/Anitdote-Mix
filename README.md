...
| 4 | Enter table number for first cocktail in the list and click the Order Button. <br /><br />Open the database in Firebase. The name of the cocktail should be captured under the branch, Name, of the database. <br /><br /> The table number should be captured under the branch, Table, of the database. | The name of cocktail and table number are captured and shown correctly under name and table branch of the database. | Pass |
| 5 | Enter table number for subsequent cocktail in the list and click the Order Button. <br /><br />Open the database in Firebase. The name of the cocktail should be captured under the branch, Name, of the database. <br /><br /> The table number should be captured under the branch, Table, of the database. | The name of cocktail and table number are not captured under name and table branch of the database. It shows blank in the Firebase database instead of table number and cocktail name entered. | Fail |
| 6 | Open the Order.html. Compare cocktail name and table number in the Order page with the Firebase database. <br /><br /> The value in the Order page and database should match. | The cocktail name and table number in the Order page and Firebase database matched. | Pass|
| 7 | In the Order.html, click on Order Done button. The cocktail name and table number should be cleared. <br /><br /> Check the Firebase database, the value in name and table branch should be cleared too. | The name and table number in the Order page and firebase database are cleared once the Order Done Button is clicked. | Pass |
| 8 | Open Index.html with different web browser. Test by using different viewport under the inspector tools, Desktop view, Tablet view, Mobile view. <br /><br />View the menu using different device, mobile, tablet and laptop.<br /><br />All the website layout should be mobile responsive and follow the layout as stated in the wireframe.<br /><br />The Preparation steps should not display in Mobile and Table View. | The website is mobile responsive with mobile, tablet, desktop and with different browser.<br /><br />The Preparation steps are not shown in Mobile and Tablet View. | Pass |
...
### Problems Encountered/Bugs yet to be solve
Due to time constraints, some error are yet to be resolve.
* I can only submit the order for first cocktail in the list. Order cannot be send to Firebase database for rest of the cocktail list. Refer to Testcase 5.
...
## Credits
* The Cocktail Photos, Ingredients and Preparation Steps are taken from API from [The CocktailDB](https://www.thecocktaildb.com/)
* The background photo was obtained from a stock image library called [Pexels](https://www.pexels.com/).
