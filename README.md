...
Customers are able to order the cocktail through the interactive menu by clicking the order button. The bartender will be able to view the order and prepare the cocktail.
